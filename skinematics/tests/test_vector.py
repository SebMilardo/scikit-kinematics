...
import unittest
from skinematics import vector, quat  # noqa: E401
...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def test_GramSchmidt(self):
        ...
        correct = array([[1., 0., 0., 0., 1.,
                          0., 0., 0., 1.],
                         [0.6882472, -0.22941573, -0.6882472, 0.62872867,
                          -0.28470732, 0.72363112, -0.36196138, -0.93075784,
                          -0.05170877]])
    ...
    def test_qrotate(self):
        ...
        correct = array([[0., 0., 0.38268343],
                         [0., 0., -0.38268343]])
        self.assertTrue(np.all(np.abs(vector.q_shortest_rotation(v1, v2) -
                                      correct) < self.delta))

        correct = array([0., 0., 0.38268343])
        self.assertTrue(norm(vector.q_shortest_rotation(v1[0], v2[0]) -
                             correct) < self.delta)
