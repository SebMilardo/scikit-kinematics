import unittest
import numpy as np
from numpy import sin, cos, array, r_, vstack
...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def setUp(self):
        ...
        sigs, pos_orients = simulate_imu(rate,
                                         duration_movement,
                                         duration_total,
                                         q_init=self.q_init,
                                         ...
                                         distance=distance,
                                         B0=B0)
        self.imu_signals = sigs
        self.body_pos_orient = pos_orients
    ...
    def test_analytical(self):
        ...
        # and then check, if the position is [0,0,0], and the
        # orientation-quat = [0, sin(45), 0]
    ...
    def test_kalman(self):
        ...
        imu = self.imu_signals
        q_kalman = imus.kalman(imu['rate'], imu['gia'],
                               imu['omega'], imu['magnetic'])
        ...
        # Get data
        inFile = os.path.join(_MYPATH, 'data', 'data_xsens.txt')
    ...
    def test_madgwick(self):
        ...
        my_sensor = MyOwnSensor(in_file='Simulated sensor-data',
                                ...
                                pos_init=self.pos_init, q_type='madgwick')
    ...
    def test_mahony(self):
        ...
        my_sensor = MyOwnSensor(in_file='Simulated sensor-data',
                                in_data=in_data,
                                R_init=quat.convert(self.q_init, to='rotmat'),
                                pos_init=self.pos_init, q_type='mahony')
    ...
    def test_IMU_calc_orientation_position(self):
        ...
        from skinematics.sensors.xsens import XSens
        sensor = XSens(in_file=inFile, R_init=initial_orientation,
