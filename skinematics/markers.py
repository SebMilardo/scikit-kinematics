...
from skinematics import quat, vector             # noqa: E401
...
def analyze_3Dmarkers(MarkerPos, ReferencePos):
    ...
    for ii in range(numPoints):
        ...
        # direction perpendicular to the triangle, is rotated along the
        # shortest path to the current orientation.  In other words, this
        # is a rotation outside the plane spanned by the three marker
        # points.
        ...
        refPos_after_q1 = vector.rotate_vector(np.reshape(ReferencePos,
                                                          (3, 3)), q1)

        # Find which further rotation in the plane spanned by the three
        # marker points is necessary to bring the data into the measured
        # orientation.
